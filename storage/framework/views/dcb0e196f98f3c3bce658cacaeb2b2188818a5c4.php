                ...
                <?php if($loop->iteration == 1): ?>
                    <div class="row w-100">
                        ...
                        <div class="col-md-3 px-md-0">
                            ...
                            <?php endif; ?>
                            <?php if($formModel->delivery_comment): ?>
                                <div class="card bg-light shadow-sm mb-2">
                                    <div class="card-body">
                                        <h5 class="card-title"><?php echo app('translator')->get('admin::lang.orders.label_delivery_comment'); ?></h5>
                                        <p class="mb-0"><?php echo e($formModel->delivery_comment); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <div class="card bg-light shadow-sm mb-2">
...
<?php /**PATH C:\laragon\www\test/app/admin/views/orders/form/form_tabs.blade.php ENDPATH**/ ?>