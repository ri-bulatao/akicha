...
return [
    'system_name' => 'AkiCha Milktea',
    'system_powered' => '<a target="_blank" href="#">Powered by Akicha Milktea</a>',
    'copyright' => 'Thank you for using <a target="_blank" href="#">AkiCha Milktea</a>',
    ...
    'mail_templates' => [
        ...
        'text_invite' => 'Invite email to staff to access the Akicha Milktea Admin',
    ...
    'permissions' => [
        ...
        'updates' => 'Ability to apply updates when a new version of Application is available',
    ],
    ...
    'settings' => [
        ...
        'text_tab_restaurant' => 'Store',
        'text_tab_mail' => 'Mail',
        'text_tab_server' => 'Advanced',

        'text_tab_desc_general' => 'Configure your store name, email, logo and geolocation settings',
        ...
        'text_test_email_message' => 'This is a test email. If you\'ve received this, it means emails are working in Akicha Milktea.',
        'text_to_customer' => 'To customer',
        'text_to_admin' => 'To store',
        ...
        'label_site_name' => 'Store Name',
        'label_site_email' => 'Store Email',
        'label_site_logo' => 'Store Logo',
    ...
    'themes' => [
        ...
        'help_components' => 'Render the component on a layout or page by adding <code>@component(&#x27;componentAlias&#x27;)</code> to the markup. Learn more <a href="#">here</a>.',
    ...
    'updates' => [
        ...
        'text_ignore' => 'Ignore',
        'text_search' => 'Search to install %s from the marketplace',
        ...
        'help_carte_key' => 'A Carte key is required to add and update item from the Marketplace. <br>Get one by creating a site from your <a href="%s" target="_blank">Account</a>, if you haven\'t already. For more information, see the <a href="%s" target="_blank">Carté Key Guide</a>',
